...
{
    /// <summary>
    /// The ActionManager checks a list of pre-determined actions for their conditions. An action with fulfilled conditions
    ...
    public class ActionManager
    {
        ...
        public ActionManager(Enemy subject, Character player)
        {
